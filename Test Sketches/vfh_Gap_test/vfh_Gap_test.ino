...
const int N = 24;  //was 10, 12 for 12 readings
const int angle = 7.5;  //was 20 degrees
...
NewPing sonarhd(39, 38, 200); // NewPing setup of pins and maximum distance.
