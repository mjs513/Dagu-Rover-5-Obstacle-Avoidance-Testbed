...
const int dir_d = 43;  //DIR for CH3
...
Dagu4Motor motor2(pwm_b, dir_b, CURRENTB, encB1, encB1); 
...
{
  motor1.setMotorDirection(BACKWD);
  motor2.setMotorDirection(BACKWD);
  motor3.setMotorDirection(BACKWD);
  motor4.setMotorDirection(FWD);
